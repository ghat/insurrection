...
print  '<tr class="pathrow">'
    ...
    ,   '</td>'
    ,   '<td class="showlog">'
    ,    '<a href="?Insurrection=atom" title="Atom Feed of activity in this directory">'
    ,     '<img src="' , &svn_IconPath('atom') , '" alt="Atom Feed of activity in this directory" align="middle"/>'
    ,    '</a>'
    ,   '</td>'
    ,   '<td class="showlog">'
