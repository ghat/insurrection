...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="svn">
    <html>
      <head>
        <title>Insurrection Browser Compatibility Test #6</title>
          ...
          <tr>
            <td id="content">
              <div style="margin: 0px; border: 0px; padding-top: 4px; text-align: center;">
                <table style="margin: auto; border: 0px; font-family: garamond, times new roman, times, serif; font-style: italic; font-weight: bold; font-size: 18pt;">
                  <tr>
                    ...
                    <td valign="bottom" align="left"><a target="_top" href=".." style="color: #bfbfbf;">Test #6</a></td>
                  </tr>
                </table>
              </div>
              <p style="border-top: 1px solid black; padding-top: 0.6em;">
                ...
                If your browser does not display this page then even simplistic XML/XSLT is not supported.  If your
                browser displays <a href="../test2.html" target="_top">Test #2</a> correctly but not this test, then the problem
                is with the XSLT output method support for html.
              </p>
              <xsl:apply-templates/>
              <div class="footer">
